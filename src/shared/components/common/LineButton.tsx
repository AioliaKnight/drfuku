...
const STYLES = {
  default: {
    button:
      'group inline-flex items-center gap-2 rounded-full bg-[#06C755] px-6 py-3 text-white shadow-md ring-1 ring-[#06C755]/30 transition-all hover:-translate-y-0.5 hover:bg-[#05b34c] hover:shadow-lg active:translate-y-0.5 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-[#06C755] focus-visible:ring-offset-2',
