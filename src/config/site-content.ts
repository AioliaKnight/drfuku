...
export const DOCTOR_COPY = {
  ...
  heroSubtitle: "20年臨床經驗｜微創手術專長",
  yearsOfExperience: 20,
  bio: "身為大腸直腸外科專科醫師，我擁有20年臨床經驗，深知肛門疾患往往帶給病患極大的生理痛苦與心理負擔。因此，我始終堅持「止痛先行、溫暖診療」的理念。身為中西醫雙學士，我不僅精進於德國 LHP 雷射消融與 LigaSure 等先進微創技術，更重視從整體的體質與生活習慣出發，為每位患者量身打造兼具精準度與人文關懷的治療方案，陪您在安心與尊嚴中找回原本自在、輕盈的生活。",
  summary: "擁有20年大腸直腸外科臨床經驗與完整專科訓練，專精於各類肛門疾病微創手術，提供顧家醫療（台中西屯、大安）、草屯佑民醫院、秘境美學診所及賦真妍整形醫美診所專業醫療服務。",
  footerBlurb: "大腸直腸外科專科醫師徐彥勳（阿福醫師），擁有20年臨床經驗，專精各類微創痔瘡手術與肛門疾患，致力於提供高品質、高隱私且專業的微創診療服務。",
}
...
/** 首頁顯示的診所據點 */
export const HERO_PRACTICE_LOCATIONS = PRACTICE_LOCATIONS
